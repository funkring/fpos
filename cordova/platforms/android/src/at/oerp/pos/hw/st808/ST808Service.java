 ...
 * T508AQ
 */
public class ST808Service extends PosHwService implements CtrlBytes {
	
	private final static String TAG = "ST808";
	...
	public static boolean isHardware() {
		return  "TPOS".equals(Build.MODEL);
	}
	...
	public ST808Service(Application app) {
		super(app);
	}
