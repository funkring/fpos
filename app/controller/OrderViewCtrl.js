                ...
                var headerTmpl = [
                    ...
                    '<tpl if="o.partner">',
                        '<table width="100%">',
                            ...
                            '<tpl if="o.partner.vat"><tr><td>{o.partner.vat}</td></tr></tpl>',
                        '</table>',
                    '</tpl>',
                    '<br/>'
                ];
                                    ...
                                    '<tpl if="(!this.hasTag(values) && !this.hasFlag(values,\'u\')) || this.hasFlag(values,\'d\')">',
                                        '<tr>',
                                            ...
                                            '<td width="60%" valign="top">',                                                   
                                                '{name}',                                               
                                            '</td>',
                                            '<td align="right" valign="top" width="32%">{[futil.formatFloat(values.subtotal_incl,Config.getDecimals())]}</td>',
                                        '</tr>',                                           
                                    '<tpl else>',
                                        '<tr>',
                                            '<td colspan="2">{name}</td>',
                ...
                var receiptTmpl = [
                    '<table width="100%">',
                        ...
                        '<tr>',                
                            '<td colspan="3"><hr/></td>',
                        '</tr>',
                        '<tpl if="o.payment_ids && o.payment_ids.length &gt; 1">',
